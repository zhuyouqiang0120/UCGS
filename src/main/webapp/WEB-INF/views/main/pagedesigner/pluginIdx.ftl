...
<script text="javascript/text" src="${basePath}/res/plugs/mod/pdesigner/mana/pluginIdx.js"></script>
</head>
<body>
<div id="mainPanel">
	...
	<div id="rightPanel">
		<div id="pluginTab0"></div>
		<div id="pluginTab1"></div>
		<div id="pluginTab2">333</div>
	</div>
</div>
</body>
</html>