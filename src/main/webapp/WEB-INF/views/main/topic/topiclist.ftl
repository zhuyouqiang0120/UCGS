...
<script type="text/javascript" src="${basePath}/res/plugs/mod/topic/list.js" ></script>
...
<body >
<input type="hidden" id="_pagetype" value="${PAGETYPE}" />
<div id="mainPanel">
	<div id="topPanel">
		<@PermisstionBtnHtml />
		<ul class="buttonTabBox buttonTabBoxExt" >
			<li>	
				...
				<input id="queryTitle" type="text" class="inputText" placeholder="输入主题名称" style="width:120px;"/><input type="button" class="button blue" onclick="TopicSet.queryTopic()"  value="查询"/>
			</li>
		</ul>
	</div>
	...
	<div id="rightPanel">
	    <div id="draglistLeft">
	  	...
	  	<div id="dragListCenter">
			<div class="topicPanelLeft" style="width:100%;overflow:auto;">
				<div><p style="text-align:center;">网站:<select id="siteItems" class="inputText select" ></select></p>
				</div>
				<div style="overflow:auto;">
					<ul id="topColumnTree" class="easyui-tree" data-options="animate:true"></ul>
				</div>
			</div>
		</div>
		<div id="dragListRight" >	
			<div id="topicDataGrid" class="topicPanelRight" style="width:100%;overflow:auto;">
			</div>	
		  </div>
	</div>
</div>	
