...
<script text="javascript/text" src="${basePath}/res/plugs/mod/admin/dimension.js"></script>
</head>
<body>
<div id="topPanel">
<@PermisstionBtnHtml />		
...
<div id="centerPanel">
<ul id="udimensionTree" class="easyui-tree" data-options="animate:true,dnd:true"></ul>
</div>
</body>
</html>
