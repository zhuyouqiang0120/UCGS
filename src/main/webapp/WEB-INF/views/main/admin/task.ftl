...
<head>
<meta charset="UTF-8">
<title>UCGS 定时任务</title>
<#include "../../common/head.ftl">
<script type="text/javascript" src="${basePath}/res/plugs/mod/admin/task.js" ></script>
<style type="text/css">
#pagePanel     {width:99%;margin:0px auto;padding:4px 0px 4px 0px;}
</style>
</head>
<body>
<div id="mainPanel">
