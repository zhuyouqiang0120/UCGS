...
function startSwfUpload(){
	...
	if($("#fileSite").val() == '') return Chasonx.Hint.Faild('请选择网站');
...
function uploadStart(file) {
	try {
		...
		if($("#fileSite")[0]) this.addPostParam('fileSite',$("#fileSite").val());
		if($("#ftype")[0])	this.addPostParam('ftype',$("#ftype").val());
		if($("#_newfilename")[0])this.addPostParam('useFileName',$("#_newfilename").attr('checked')?1:0);
